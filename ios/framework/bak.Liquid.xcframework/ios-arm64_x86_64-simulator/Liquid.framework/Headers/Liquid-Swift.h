...
/// 在留カードが保有している情報の種別 (Objective-C用)<br />
...
/// 在留カードが保有している情報の種別(<code>residenceCardInfoTypeValue</code>)が有効な値かどうか (Objective-C用)<br />
...
/// 在留カードの種別(<code>residenceCardTypeValue</code>)が有効な値かどうか (Objective-C用)<br />
...
///
/// \param rawData RAWデータ<br />運転免許証時: DriverLicenseRawData<br/>マイナンバーカード時: MynumberCardRawData<br/>在留カード時: ResidenceCardRawData
///
/// \param viewController 指定された viewController 上で画面が表示されます
///
/// \param completion ファンクションの処理結果が返ります
...
/// \param verifyingParams 検証パラメータ
///
/// \param rawData RAWデータ<br />在留カード時: ResidenceCardRawData
///
/// \param viewController 指定された viewController 上で画面が表示されます
///
/// \param completion ファンクションの処理結果が返ります
...
///
/// \param residenceCardInfoType 在留カードが保有している情報の種別
///
/// \param residenceCardType 在留カードの種別
///
...
/// ICチップが特殊（在留カード） “chip_unusual_residencecard”
...
/// ICチップ(ただし在留カードのみ)でPIN間違い許容回数超過 “chip_pin_failure”
